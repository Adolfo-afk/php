...
-- Tiempo de generación: 06-03-2025 a las 11:45:04
...
--
-- Base de datos: `adolfo`
--
CREATE DATABASE IF NOT EXISTS `adolfo` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `adolfo`;
...
CREATE TABLE `alumnos` (
  ...
  `promociona` tinyint(1) NOT NULL DEFAULT 0
...
INSERT INTO `alumnos` (`id`, `nombre`, `edad`, `curso`, `promociona`) VALUES
(1, '', NULL, NULL, 0),
(3, 'Maria', 24, 'ASIR2', 0),
(4, 'adolfo', 23, 'ASIR2', 1),
(5, 'pepeee', 23, 'ASIR2', 1);
...
-- Base de datos: `fauna`
--
CREATE DATABASE IF NOT EXISTS `fauna` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `fauna`;
--
-- Base de datos: `faunacompleja`
--
CREATE DATABASE IF NOT EXISTS `faunacompleja` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `faunacompleja`;
...
('root', '[{\"db\":\"faunacompleja\",\"table\":\"usuarios\"},{\"db\":\"faunacompleja\",\"table\":\"habitats\"},{\"db\":\"faunacompleja\",\"table\":\"regiones\"},{\"db\":\"faunacompleja\",\"table\":\"observaciones\"},{\"db\":\"faunacompleja\",\"table\":\"fauna\"},{\"db\":\"faunacompleja\",\"table\":\"especies\"},{\"db\":\"faunacompleja\",\"table\":\"alimentacion\"},{\"db\":\"adolfo\",\"table\":\"alumnos\"}]');
...
('root', '2025-03-06 10:44:33', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"es\",\"NavigationWidth\":0}');
